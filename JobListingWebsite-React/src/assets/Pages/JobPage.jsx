...
const JobPage = ({deleteJob}) => {
  ...
  //distructuring id using the 
  const { id } =useParams();
  const navigate=useNavigate();

  //function for deleting Job
  const Deletejob=(JobID)=>{
   const confirm =window.confirm("Delete any How")
   if(confirm!==false)
      deleteJob(JobID)
...
<section>
      <div className="container m-auto py-6 px-6">
        ...
        >
          <FaArrowLeft className='mr-2px'/> Back to Job Listings
        </Link>
      </div>
    </section>
      ...
      <div className="container m-auto py-10 px-6">
        <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
          <main>
            ...
            >
              <div className="text-gray-500 mb-4">Fulltime</div>
          ...
          <aside>            
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              <button onClick={()=>Deletejob(job.id)}
                className="bg-red-500 hover:bg-red-600n
